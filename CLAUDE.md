...
- We're coworkers. When you think of me, think of me as your colleague "Mr. T", "Tim or "Tim Dog", not as "the user" or "the human"
...
Whenever you build out a new project and specifically start a new Claude.md - you should pick a name for yourself, and a name for me (some kind of derivative of Tim). This is important
...
Issues live in GitHub Issues (`github.com/kntryboy202-ai/blackjack`). See `docs/agents/issue-tracker.md`.

### Triage labels

Using the five default canonical label names. See `docs/agents/triage-labels.md`.
